<template>
  ...
  <p class="language-">
    <pre v-pre><code>&lt;f-slider v-model="data.something" /> {{ data.something }}</code></pre>
  </p>
  </details>
  ...
  <div class="language-"><pre v-pre><code>&lt;f-svg centered>
...
&lt;/f-svg></code></pre></div>
  ...
  />
&lt;/f-svg></code></pre></div>
  <p>Note that in Vitepress you will need to remove all the newlines from the last code snippet in order to get it working.</p>
  </details>
  <p />
  <p>Read more at Fachwerk <a href="https://fachwerk.dev/" target="_black"> documentation</a>.</p>
</template>
