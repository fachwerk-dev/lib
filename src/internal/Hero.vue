...
<template>
  <article class="grid min-h-screen auto-rows-min gap-4 md:py-20 lg:gap-6">
    <h1
    ...
    <div class="grid gap-4 md:flex">
      <Button
        class="bg-white hover:bg-white/80 lg:text-xl"
        to="/get-started/vite"
      >
        <IconDocs />
        Play with docs
      ...
      <Button class="lg:text-xl" href="https://slides.fachwerk.dev">
        <IconSlides />
        See the slides
      </Button>
    </div>
